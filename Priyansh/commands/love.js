...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/jeabWYT.jpeg", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(180, 200), 100, 200).composite(circleTwo.resize(160, 200), 495, 120);
